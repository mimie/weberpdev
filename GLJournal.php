...
//echo '<a href="' . $rootpath . '/print/printJV.php?DebitTotal='.$DebitTotal.'&amp;CreditTotal='.$CreditTotal.'&amp;ProcessDate='.$_POST['JournalProcessDate'].'&amp;GLItems='.$JournalItem.'">Print JV</a>';
...
echo '</tr>
	...
	<tr>
		...
		<td colspan="2"><input type="text" name="GLNarrative" maxlength="100" size="100" value="' . $_POST['GLNarrative'] . '" /></td>
	</tr>
	</table>
...
//die(implode(',',$JournalItem));

//$serialized = rawurlencode(serialize($JournalItem));
...
//echo	'<td><a href="' . $rootpath . '/print/printJV.php?DebitTotal='.$DebitTotal.'&amp;CreditTotal='.$CreditTotal.'&amp;ProcessDate='.$_POST['JournalProcessDate'].'&amp;GLItems='.$serialized .'">Print JV</a></td>
...
//echo '<tr><td><a href="' . $rootpath . '/print/printJV.php?DebitTotal='.$DebitTotal.'&amp;CreditTotal='.$CreditTotal.'&amp;ProcessDate='.$_POST['JournalProcessDate'].'&amp;GLItems='.$JournalItem.'">Print JV</a></td></tr>';
...
if (abs($_SESSION['JournalDetail']->JournalTotal)<0.001 AND $_SESSION['JournalDetail']->GLItemCounter > 0){
	echo '<br />
			...
			<a href="' . $rootpath . '/print/printJV.php?DebitTotal='.$DebitTotal.'&amp;CreditTotal='.$CreditTotal.'&amp;ProcessDate='.$_POST['JournalProcessDate'].'&amp;GLItems='.$_SESSION['JournalDetail']->GLEntries .'&amp;UserName='.$Uname.'" target="_blannk">Print Journal Voucher</a><br>';
...
//echo '<div><a href="' . $rootpath . '/print/printJV.php?DebitTotal='.$DebitTotal.'&amp;CreditTotal='.$CreditTotal.'&amp;ProcessDate='.$_POST['JournalProcessDate'].'&amp;GLItems='.$_SESSION['JournalDetail']->GLEntries.'">Print JV</a></div>';
