...
/* $Id: PrintCustTransPortrait.php 5692 2012-10-02 06:12:32Z daintree $ */
...
// Print Bank acount details if available and default for invoices is selected
	...
	if (isset($_GET['Email'])){ //email the invoice to address supplied
		include ('includes/htmlMimeMail2.php');
		...
		$FileDir = $_SESSION['reports_dir'] . '/' . $_SESSION['DatabaseName'] . '_' . $InvOrCredit . '_' . $_GET['FromTransNo'] . '.pdf';
		...
		$result = $mail->send(array($_GET['Email']),'smtp');
